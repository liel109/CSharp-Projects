...
namespace Ex02
{
    public class GameUI
    {
        ...
        internal static void DeclareWinner(ePlayerMark i_WinnerMark, Player[] i_Players)
        {
            if (i_WinnerMark == ePlayerMark.None)
            {
...
{3,8}{4,8}", i_WinnerMark, i_Players[0].Mark, i_Players[0].Score, i_Players[1].Mark, i_Players[1].Score));
        ...
        private static char getCharMarkForPlayer(ePlayerMark i_PlayerType)
        {
